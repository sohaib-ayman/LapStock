    ...
    <div class="main-content">
        <div class="container-fluid px-4 py-4">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="stat-card shadow-sm">
                        <div class="icon-box bg-warning-subtle text-warning"><i class="bi bi-exclamation-triangle"></i>
                        </div>
                    ...
                    <div class="bg-white rounded-3 p-3 border shadow-sm h-100">
                        <div class="d-flex justify-content-between align-items-center mb-3 px-2">
                            ...
                            <a href="./products/index.php"
                                class="text-primary text-decoration-none small fw-semibold">View All &rarr;</a>
                        </div>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-secondary small">
                                                    <?php echo htmlspecialchars($row['brand_name'] ?? 'N/A'); ?>
                                                </td>
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div class="bg-white rounded-3 p-3 border shadow-sm">
                            <h6 class="fw-bold text-dark mb-3"><i
                                    class="bi bi-exclamation-triangle-fill text-warning me-2"></i>Low Stock Items</h6>
                        ...
                        <div class="bg-white rounded-3 p-3 border shadow-sm">
                            <h6 class="fw-bold text-dark mb-3"><i class="bi bi-x-circle-fill text-danger me-2"></i>Out
                                of Stock Items</h6>
                            <div class="d-flex flex-column gap-2">
                                <?php
                                    ...
                                    while ($oRow = mysqli_fetch_assoc($outRes)) {
                                        ...
                                        <div class="d-flex justify-content-between align-items-center pb-2 border-bottom">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <div class="fw-semibold small">
                                                        <?php echo htmlspecialchars($oRow['name']); ?>
                                                    </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="bg-white p-3 rounded-3 border shadow-sm">
                        <h6 class="fw-bold text-dark mb-3"><i class="bi bi-bar-chart-fill text-primary me-2"></i>Brand
                            Distribution</h6>
                ...
                <div class="col-md-6">
                    <div class="bg-white p-3 rounded-3 border shadow-sm">
                        <h6 class="fw-bold text-dark mb-3"><i class="bi bi-pie-chart-fill text-purple me-2"></i>Category
                            Distribution</h6>

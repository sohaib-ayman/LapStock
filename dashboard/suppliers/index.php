...
if (isset($_GET["delete"])) {
    ...
    $checkQuery = "SELECT COUNT(*) AS total FROM products WHERE supplier_id = $id";
    ...
    if (!$checkResult) {
        ...
        if ($row['total'] > 0) {
            $errorMessage = "Supplier Can't be Deleted because it has products.";
        } else {
            ...
            if ($deleteResult) {
                ...
                $errorMessage = "Supplier Can't be Deleted: " . mysqli_error($conn);
            }
        }
    }
}
                                        ...
                                        <?php foreach ($suppliers as $supplier) { ?>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div
                                                            ...
                                                            <?php if ($supplier['image']) { ?>
                                                                <img class="w-100"
                                                                    src="/LapStock/uploads/suppliers/<?php echo $supplier['image']; ?>"
                                                                    alt="">
                                                            <?php } else { ?>
                                                ...
                                                <td>
                                                    <div>
                                                        <span
                                                            class="<?php echo $supplier['status'] ? 'status' : 'statusInactive' ?>">
                                                            <i class="bi bi-dot"></i>
